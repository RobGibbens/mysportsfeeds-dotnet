...
{ 
    public class GamePlayByPlay
    {
        ...
        /// The URL
        /// </summary>
        private const string Url = "/pull/mlb/{0}/game_playbyplay.json";
        ...
        /// <returns></returns>
        public async Task<GamePlayByPlayResponse> Get(int year, SeasonType seasonType, RequestOptions requestOptions = null)
        {
